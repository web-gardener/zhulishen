...
drawStatic() {
    ...
    this.mask.forEach(subMask => {
        subMask.s.forEach(pos => {
            ...
            // Change the fillStyle color to black
            this.engine.fillStyle = color(subMask.hsl, this.opa * opa * 0.2).replace('hsla', '#c3e0f7');
